...
Library.prototype.initialize = function() {
    ...
    self.adapter.setObjectNotExists("batteries.0.id", {
        type: "state",
        common: {
            name: "ID",
            type: "number",
    ...
    self.adapter.setObjectNotExists("batteries.0.charge", {
        type: "state",
        common: {
            name: "Charge",
            type: "number",
    ...
    self.adapter.setObjectNotExists("batteries.0.voltage", {
        type: "state",
        common: {
            name: "Voltage",
            type: "number",
    ...
    self.adapter.setObjectNotExists("batteries.0.current", {
        type: "state",
        common: {
            name: "Current",
            type: "number",
    ...
    self.adapter.setObjectNotExists("batteries.0.temperature", {
        type: "state",
        common: {
            name: "Temperature",
            type: "number",
    ...
    self.adapter.setObjectNotExists("batteries.0.capacity.full",{
        type: "state",
        common: {
            name: "Full capacity",
            type: "number",
    ...
    self.adapter.setObjectNotExists("batteries.0.capacity.remaining",{
        type: "state",
        common: {
    ...
    self.adapter.setObjectNotExists("extension.gpio1.flashonerror",{
        type: "state",
        common: {
            name: "Flash on error",
            type: "boolean",
    ...
    self.adapter.setObjectNotExists("extension.gpio2.flashonerror",{
        type: "state",
        common: {
            name: "Flash on error",
            type: "boolean",
    ...
    self.adapter.setObjectNotExists("extension.out1.flashonerror",{
        type: "state",
        common: {
            name: "Flash on error",
            type: "boolean",
    ...
    self.adapter.setObjectNotExists("extension.out2.flashonerror",{
        type: "state",
        common: {
            name: "Flash on error",
            type: "boolean",
    ...
    self.adapter.setObjectNotExists("status.distance", {
        type: "state",
        common: {
    ...
    self.adapter.setObjectNotExists("status.stopped", {
        type: "state",
        common: {
            name: "Stopped",
            type: "boolean",
    ...
    self.adapter.setObjectNotExists("portal.enabled", {
        type: "state",
        common: {
            name: "Enabled",
            type: "boolean",
    ...
    self.adapter.setObjectNotExists("portal.connected", {
        type: "state",
        common: {
            name: "Connected",
            type: "boolean",
    ...
    self.adapter.setObjectNotExists("portal.address.domain", {
        type: "state",
        common: {
            name: "Domain",
            type: "string",
    ...
    self.adapter.setObjectNotExists("portal.address.url", {
        type: "state",
        common: {
            name: "URL",
            type: "string",
    ...
    self.adapter.setObjectNotExists("portal.address.host.default", {
        type: "state",
        common: {
            name: "Default",
            type: "string",
    ...
    self.adapter.setObjectNotExists("portal.address.host.friendly", {
        type: "state",
        common: {
            name: "Friendly",
            type: "string",
    ...
    self.adapter.setObjectNotExists("timer.next_unix", {
        type: "state",
        common: {
            name: "Next timer time",
            type: "number",
    ...
    self.adapter.setObjectNotExists("blades.quality", {
        type: "state",
        common: {
            name: "Blades quality",
            type: "number",
    ...
    self.adapter.setObjectNotExists("blades.hours", {
        type: "state",
        common: {
            name: "Blades hours",
            type: "number",
    ...
    self.adapter.setObjectNotExists("blades.days", {
        type: "state",
        common: {
            name: "Blades days",
            type: "number",
    ...
    self.adapter.setObjectNotExists("wlan.station.ping", {
        type: "state",
        common: {
            name: "Ping activated",
            type: "boolean",
...
/** Poll */
Library.prototype.poll = function(type) {
    var self = this;
        ...
        if(isAlive) {
            ...
            if(type === 'Initial') {
                ...
                if(self.currentStatus != null && self.currentStatus != 17 /*schlafen*/) {
                    if(self.batteryPollType === type) await self.pollBattery();
                    if(self.errorsPollType === type) await self.pollErrors();
                    if(self.extensionPollType === type) await self.pollExtension();
                    if(self.hoursPollType === type) await self.pollHours();
                    if(self.motorPollType === type) await self.pollMotor();
                    if(self.portalPollType === type) await self.pollPortal();
                    if(self.pushPollType === type) await self.pollPush();
                    if(self.timerPollType === type) await self.pollTimer();
                    if(self.versionPollType === type) await self.pollVersion();
                    if(self.wlanPollType === type) await self.pollWlan();
                }
            }
...
/** Poll battery */
Library.prototype.pollBattery = async function() {
    let self = this;
...
/** Poll errors */
Library.prototype.pollErrors = async function() {
    let self = this;
...
/** Poll extension */
Library.prototype.pollExtension = async function() {
    let self = this;
...
/** Poll hours */
Library.prototype.pollHours = async function() {
    let self = this;
...
/** Poll motor */
Library.prototype.pollMotor = async function() {
    let self = this;
...
/** Poll portal */
Library.prototype.pollPortal = async function() {
    let self = this;
...
/** Poll push */
Library.prototype.pollPush = async function() {
    let self = this;
...
/** Poll status */
Library.prototype.pollStatus = async function() {
    let self = this;
...
/** Poll timer */
Library.prototype.pollTimer = async function() {
    let self = this;
...
/** Poll version */
Library.prototype.pollVersion = async function() {
    let self = this;
...
/** Poll WLAN */
Library.prototype.pollWlan = async function() {
    let self = this;
...
Library.prototype.updateExtensionStatus = function(ext, status) {
    var self = this;
...
/** Update mode */
Library.prototype.updateMode = function(mode) {
    var self = this;
    var mode = mode;
